	...
	<div class="tab-content">
		<div class="tab-pane fade in active" id="customer_basic_info">
			<fieldset>
				...
				<div class="form-group form-group-sm">
					<?php echo form_label($this->lang->line('customers_tax_bill'), 'tax_bill', array('class' => 'control-label col-xs-3')); ?>
					<div class='col-xs-8'>
						<?php echo form_input(array(
								'name'=>'tax_bill',
								'id'=>'tax_bill',
				...
				<div class="form-group form-group-sm">
					<?php echo form_label($this->lang->line('customers_gbill_sbill'), 'gbill_sbill', array('class' => 'control-label col-xs-3')); ?>
					<div class='col-xs-8'>
						<?php echo form_input(array(
								'name'=>'gbill_sbill',
								'id'=>'gbill_sbill',
				...
				<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('customers_payment_modes'), 'payment_modes', array('class'=>'control-label col-xs-3')); ?>
			<div class='col-xs-8'>
			<select name="payment_modes" id="payment_modes required="" class='form-control'>
